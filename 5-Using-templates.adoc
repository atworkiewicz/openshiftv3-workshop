...
First switch to the new project:
****
...
Now run the database `bootstrap` script. The URL will be displayed by `oc get route` 
....
$ oc get route
...
Then open a browser and point to *http://pricelist-consoleproject-Username.apps.workshop.osecloud.com/create_database.php*. You will see following output.
...
Go ahead and open your application. When you open your application, click on the "Create Record" button and create a record.
